...
localidades = {
    ...
    "14": {"nombre": "Ocotepeque", "municipios": {"01": "Ocotepeque", "02": "Belén Gualcho", "03": "Concepción", "04": "Dolores Merendón", "05": "Fraternidad", "06": "La Encarnación", "07": "La Labor", "08": "Lucerna", "09": "Mercedes", "10": "San Fernando", "11": "San Francisco del Valle", "12": "San Jorge", "13": "San Marcos", "14": "Santa Fe", "15": "Sensenti", "16": "Sinuapa"}},
    ...
    "16": {"nombre": "Santa Bárbara", "municipios": {"01": "Santa Bárbara", "02": "Arada", "03": "Atima", "04": "Azacualpa", "05": "Ceguaca", "06": "San Jose de Colinas", "07": "Concepcion del Norte", "08": "Concepción del Sur", "09": "Chinda", "10": "El Nispero", "11": "Gualala", "12": "Ilama", "13": "Macuelizo", "14": "Naranjito", "15": "Nuevo Celilca", "16": "Petoa", "17": "Proteccion", "18": "Quimistan", "19": "San Francisco de Ojuera", "20": "San Luis", "21": "San Marcos", "22": "San Nicolas", "23": "San Pedro Zacapa", "24": "Santa Rita", "25": "San Vicente Centenario", "26": "Trinidad", "27": "Las Vegas", "28": "Nueva Frontera"}},
...
def menu():
    while True:
        ...
        print("5. Ejercicio 2 Verificar contraseña")
        print("6. Ejercicio 12 Calcular edad" )
        print("5. Salir")
        ...
        if opcion == "1":
            ...
            contra = input("Ingrese una contraseña: ").upper()
            if contra_var == contra:
